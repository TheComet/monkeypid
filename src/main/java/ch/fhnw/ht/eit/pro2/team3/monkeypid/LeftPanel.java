...
public class LeftPanel extends JPanel implements ActionListener {
	...
	private JLabel lbEnterKsTuTgTitle = new JLabel(
			"Eingabe der Kenngr�sse der Regelstrecke:");
	...
	private JLabel lbTimeConstantTitle = new JLabel("Parasit�re Zeitkonstante:");
	private JLabel lbTp = new JLabel("Tp");
	private JLabel lbTuInfo = new JLabel("%   (standardm�ssig 10% von Tg)");
	...
	private JLabel lbPhasengangmethodTitle = new JLabel(
			"�berschwingen der Phasengangmethode:");
	...
	private JLabel lbListeTitelUeberschwingen = new JLabel("�berschwingen");

	// Test Tabelle
	private JTable tbTest = new JTable(10, 5);

	// Button Loeschen
	private JButton btDelete = new JButton("L�schen");
