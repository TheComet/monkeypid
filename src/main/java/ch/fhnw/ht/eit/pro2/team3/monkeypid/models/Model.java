    ...
    private class CalculationCycle implements Runnable {
        ...
        public void run() {
            ...
            if (controller.getMaxKr() > controller.getMinKr()) {
                ...
                System.out.println("topKr: " + topKr);
                System.out.println("bottomKr: " + bottomKr);
                System.out.println("actualKr: " + actualKr);
                System.out.println("targetOverSwing: " + targetOverswing);
                for (int i = 0; i < 9; i++) {
                    ...
                    if (closedLoop.getOverswing() > targetOverswing) {
                        ...
                        System.out.println("Overshoot: " + closedLoop.getOverswing());
                    } else {
                        bottomKr = actualKr;
                        actualKr = (topKr + bottomKr) / 2.0;
                        System.out.println("Undershoot: " + closedLoop.getOverswing());
                    }
